#!/bin/bash
# Release script for corena-authorization.
...
dist="./build/dist/"
build="./build/"
plugin_root="./build/kibana/corena-authorization/"
...
# 1. the zip utility is not able to prefix the root dir with kibana/corena-authorization inside the zip.
...
out="./dist/corena-authorization-$platform-$version.zip"
